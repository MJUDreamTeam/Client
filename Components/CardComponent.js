    ...
    render() {
        return (
            <Card>
                <CardItem>
                    <Left>
                        <Thumbnail source={{uri: 'https://rdd9223.github.io/assets/images/profile.jpg'}} />
                        <Body>
                            <Text>강영우</Text>
                ...
                <CardItem>
                    <Text>
                        ...
                        흥흥항 이제 너무 재밌당 히히히히 뭐가 어떻게 되는지는 잘 모르겠지만 지금 만들어 보니너무 기쁘다 하하하하
                    </Text>
                </CardItem>
            </Card>
        );
